                            ...
                            <div class="col-md-12">
                                    ...
                                    <div class="table-data__tool-left">
                                        <form action="#" method="post">
                                            <div class="rs-select2--light rs-select2--md">
                                                <input type="text" name="date" value="YY-MM-DD" placeholder="2000-01-01" class="form-control">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <?php
                                            $result = mysqli_query($link, "Select * from global where (publisher='admin' OR publisher='" . $session_faculty . "') AND (dname like '%$dname%' OR dname='ALL') order by gid desc");
                                            ...
                                            ?>
                                                <tr class="tr-shadow">
                                                    ...
                                                    <?php
                                                    if ($row['publisher'] == 'admin') {
                                                        echo "<td>";
                                                        if ($row['status'] == 'ACTIVE') {
                                                    ?>
                                                            <button style="cursor: not-allowed;" id="<?php echo $row['gid']; ?>"><?php echo "<i class='greendot'></i>"; ?></button>
                                                        <?php
                                                        } else if ($row['status'] == 'INACTIVE') {
                                                        ?>
                                                            <button style="cursor: not-allowed;" id="<?php echo $row['gid']; ?>"><?php echo "<i class='greydot'></i>"; ?></button>
                                                        <?php
                                                            echo "</td>";
                                                        }
                                                    } else {
                                                        ...
                                                        <div class="table-data-feature">
                                                            ...
                                                            ?>
                                                                ...
                                                                <button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                                                    <a href="global_delete.php?gid=<?php echo $row['gid'] ?>"><i class="zmdi zmdi-delete"></i></a>
                                                                </button>
                                                            <?php
                                                            }
                                                            ?>
