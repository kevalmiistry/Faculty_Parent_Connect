...
if (isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($link, "update global set publisher='$pub', title='$title',desci='$desci',date='$date',status='$status',dname='$dname',sem='$sem' where gid=" . $_GET['gid']);
    $msg = "success";
                                        ...
                                        <div class="card-body card-block">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="pub" value="<?php echo $rowe['publisher']; ?>" class="form-control"  readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    ...
                                                    if ($dname_arr == 'ALL') {
                                                    ?>
                                                        <input type="checkbox" id="dcheckall" name="dall" value="ALL" checked> ALL <br>
                                                        <?php
                                                        $res = mysqli_query($link, "SELECT * FROM department");
                                                        while ($row = mysqli_fetch_assoc($res)) {
                                                        ?>
                                                            <input type="checkbox" class="ditem" name='arr_dname[]' value="<?php echo $row['dname']; ?>" checked> <?php echo $row['dname']; ?> <br>
                                                        <?php
                                                        }
                                                    } else {
                                                        ?>
                                                        ...
                                                        while ($row = mysqli_fetch_assoc($res)) {
                                                            $d_checked = "";
                                                            if (in_array($row['dname'], $dname_arr)) {
                                                                $d_checked = "checked";
                                                            }
                                                        ?>
                                                            <input type="checkbox" class="ditem" name='arr_dname[]' value="<?php echo $row['dname']; ?>" <?php echo " " . $d_checked; ?>> <?php echo $row['dname']; ?> <br>
                                                    <?php
                                                        }
                                                    }
                                                    ?>
