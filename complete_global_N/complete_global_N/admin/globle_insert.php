...
if (isset($_POST['Submit'])) {
    ...
    if (isset($_POST['dall'])) {
        $dname = "ALL";
    } else if (isset($_POST['arr_dname'])) {
        $dname = implode(",", $_POST['arr_dname']);
    }
    ...
    $result = mysqli_query($link, "Insert into global(publisher,title,desci,date,status,sem,dname) values('$pub','$title','$desc','$date','$status','$sem','$dname')");
                                        ...
                                        <div class="card-body card-block">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="pub" value="<?php echo $pub; ?>" class="form-control" required readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="email-input" class=" form-control-label">Dscription</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <textarea name="desc" rows="6.5" class="form-control" placeholder="Enter Description here" required></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="email-input" class=" form-control-label">Department</label>
                                                </div>

                                                <!-- Department Start  -->
                                                <div class="col-12 col-md-9">
                                                    <input type="checkbox" id="dcheckall" name="dall" value="ALL"> ALL <br>
                                                    <?php
                                                    $res = mysqli_query($link, "SELECT * FROM department");
                                                    while ($row = mysqli_fetch_assoc($res)) {
                                                    ?>
                                                        <input type="checkbox" class="ditem" name='arr_dname[]' value="<?php echo $row['dname']; ?>"> <?php echo $row['dname']; ?> <br>
                                                    <?php
                                                    }
                                                    ?>
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="email-input" class=" form-control-label">Semester</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($res)) {
                                                    ?>
                                                        <input type="checkbox" class="sitem" name='arr_sem[]' value="<?php echo $row['sem']; ?>"> <?php echo $row['sem']; ?> <br>
                                                    <?php
                                                    }
                                                    ?>
                                                </div>
