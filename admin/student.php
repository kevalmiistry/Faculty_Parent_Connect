...
$result = mysqli_query($link, "SELECT * FROM student ORDER BY `sid` DESC LIMIT " . $this_page_first_result . ',' .  $results_per_page);
...
if (isset($_POST['search'])) {
    $errno = $_POST['erno'];
    $result = mysqli_query($link, "Select * from student where erno='$errno'");
}
?>
                                    ...
                                    <div class="table-data__tool-left">
                                        <form action="#" method="post">
                                            <div class="rs-select2--light rs-select2--md">
                                                <select class="js-select2" name="dept" size="">
                                    ...
                                    <div class="table-data__tool-right">
                                        ...
                                        <a href="student_insert.php">
                                            <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                                <i class="zmdi zmdi-plus"></i>add student</button></a>
                                                ...
                                                <tr class="tr-shadow">
                                                    ...
                                                    <td>
                                                        <div class="table-data-feature">
                                                            <div>
                                                                <button style="margin-bottom: 3px;" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <a href="student_edit.php?sid=<?php echo $row['sid']; ?>"><i class="zmdi zmdi-edit"></i></a>
                                                                </button>
                                                                <button style="margin-top: 3px;" class="item" data-toggle="tooltip" data-placement="top" title="Parent Insert">
                                                                    <a href="parent_insert.php?sid=<?php echo $row['sid']; ?>"><i class="fas  fa-plus"></i></a>
                                                                </button>
                                                            </div>
                                                            <div>
                                                                <button style="margin-bottom: 3px;" class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                                                    <a href="student_delete.php?sid=<?php echo $row['sid']; ?>"><i class="zmdi zmdi-delete"></i></a>
                                                                </button>

                                                                <button style="margin-top: 3px;" class="item" data-toggle="tooltip" data-placement="top" title="View" data-original-title="More" aria-describedby="tooltip181541">
