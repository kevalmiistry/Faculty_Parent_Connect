...
<body>
    ...
    <script>
        function popup() {
            var ms = "<?php echo $msg ?>";
            if (ms == "Password incorrect") {
                Swal.fire('Oops!', 'Password Incorrect!', 'error')
            } else if (ms == "Username incorrect") {
                Swal.fire('Oops!', 'Username incorrect!', 'error')
            } else if (ms == "Wrong code Entered") {
                Swal.fire('Oops!', 'Wrong code Entered!', 'error')
            }
        }
    </script>
