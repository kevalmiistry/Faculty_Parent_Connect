...
if (isset($_POST['Submit'])) {
    ...
    if ($_FILES['file']['name'] != "") {
        copy(
            ...
            "../faculty_photos/" . $dateforphoto . $_FILES['file']['name']
        )
    ...
    //strtoupper($fname);
    //strtoupper($lname);
    $check_duplicate = "select * from faculty where email='$email'";
    ...
    if ($count > 0) {
        ...
        //if(!isset($_GET['fid']))
        //{		
        $result = mysqli_query($link, "Insert into faculty(pname,dname,email,password,fname,lname,faculty_no,status,dob,cast,ma_status,country,mobile,pno,aadhar,address,photo) values('$pname','$dname','$email','$password',UPPER('$fname'),UPPER('$lname'),'$faculty_no','$status','$dob','$cast','$ma_status','$country','$mobile','$pno','$aadhar','$address','$dateforphoto$photo')");
        $msg = "success";
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <div class="col-12 col-md-12">
                                                    <select name="pname" id="select" class="form-control" required>
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <div class="col-12 col-md-12">
                                                    <select name="dname" id="select" class="form-control" required>
                                                        <option value="">Please select</option>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" placeholder="Enter E-mail" class="form-control" autocomplete="off" required>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="number" name="faculty_no" placeholder="Enter Id No." class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select name="ma_status" class="form-control" required>
                                                    ...
                                                    <option value="Currently Married">Married</option>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="number" name="pno" placeholder="Enter Phone Number" class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="number" name="aadhar" placeholder="Enter Aadhaar card" class="form-control" required> </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
