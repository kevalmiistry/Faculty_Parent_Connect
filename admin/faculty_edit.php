...
if (isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($link, "Update faculty set pname='$pname', dname='$dname',email='$email',password='$password',fname=UPPER('$fname'),lname=UPPER('$lname'),status='$status',dob='$dob',cast='$cast',ma_status='$ma_status',country='$country',mobile='$mobile',pno='$pno',aadhar='$aadhar',address='$address' where fid=" . $_GET['fid']);
    ...
    <div class="page-wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card-header">
                                    <strong>
                                        <center>
                                            <font style="font-size:30px;">Faculty Update</font>
                                        </center>
                                    </strong>
                                </div>
                            </div>
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <div class="col-12 col-md-12">
                                                    <select name="dname" id="select" class="form-control" required>
                                                        ...
                                                        <?php
                                                        $resdept = mysqli_query($link, "select * from department");
                                                        while ($rowdept = mysqli_fetch_array($resdept, MYSQLI_BOTH)) {
                                                        ?>
                                                            <option value="<?php echo $rowdept['dname']; ?>"><?php echo $rowdept['dname']; ?></option>
                                                        <?php
                                                        }
                                                        ?>
                                                    </select>
        ...
        <script>
            function popup() {
                var ms = "<?php echo $msg ?>";
                if (ms == "success") {
                    Swal.fire('Good!', 'Faculty Detail Updated!', 'success')
                } else if (ms == "error") {
                    Swal.fire('Oops!', 'Can not Update Faculty Update!', 'error')
                }
            }
        </script>
