...
if(isset($_POST['Submit']))
	{
		...
		$result = mysqli_query($link,"Update department set dname=UPPER('$dname'), dcode=UPPER('$dcode') where did=".$_GET['did']);
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                            	<div class="card-header">
                                    <strong><center><font style="font-size:30px;">Department Update</font></center></strong>
                                </div>
                            </div>
                                        ...
                                        <form action="" method="post">
                                            <div class="form-group">
                                               <label for="cc-payment" class="control-label mb-1">Department Name</label> 
                                                <input type="text" name="dname" placeholder="Enter Department" class="form-control" required value="<?php echo $rowe['dname']; ?>" >
                                          </div>
                                            <div class="form-group has-success">
                                                 <label for="cc-name" class="control-label mb-1">Department Code</label>
                                            	<input type="text" name="dcode" placeholder="Enter Department Code" class="form-control" required value="<?php echo $rowe['dcode']; ?>" >
                                            </div>
                                    </div>
                                </div>
                            </div>
