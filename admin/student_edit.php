...
if (isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($link, "Update student set year='$year', current_year='$c_year', dept='$dept',erno='$ernoo',sem='$sem',semail='$semail',fname=UPPER('$fname'),lname=UPPER('$lname'),gender='$gender',status='$status',dob='$dob',quali='$quali',state='$state',city='$city',pincode='$pincode',smobile='$smobile',sphone='$sphone',aadhaar='$aadhaar',address='$address' where sid=" . $_GET['sid']);
    $res = mysqli_query($link, "update parent set erno='$ernoo' where erno='$erno' ");
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card-header">
                                    <strong>
                                        <center>
                                            <font style="font-size:30px;">Student Update</font>
                                        </center>
                                    </strong> </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="c_year" placeholder="Enter year" class="form-control" value="<?php echo $rowe['current_year']; ?>" required>
                                            </div>
                                            <div class="form-group has-success">
                                                ...
                                                <select name="dept" id="select" class="form-control" required>
                                                    <option value="<?php echo $rowe['dept']; ?>"><?php echo $rowe['dept']; ?></option>
                                                    <?php
                                                    $resdpt = mysqli_query($link, "select * from department");
                                                    while ($rowdpt = mysqli_fetch_array($resdpt, MYSQLI_BOTH)) {
                                                        $n++;        ?>
                                                        <option value="<?php echo $rowdpt['dname']; ?>"><?php echo $rowdpt['dname']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                    </div>
