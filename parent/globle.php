                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <?php
                                            $res = mysqli_query($link, "Select * from global where (publisher='admin' OR publisher='$hodname') AND (dname like '%$dname%' OR dname='ALL') AND (sem like '%$s_sem%' OR sem='ALL') AND status='ACTIVE' order by gid desc");
