...
or die ("could not copy file");
	...
	{
	 $result = mysqli_query($link,"insert into student(year,dept,erno,sem,fname,lname,gender,status,dob,quali,semail,state,city,pincode,smobile,sphone,aadhaar,address,photo) values('$year','$dept','$erno','$sem',UPPER('$fname'),UPPER('$lname'),'$gender','$status','$dob','$quali','$semail','$state','$city','$pincode','$smobile','$sphone','$aadhaar','$address','$photo')");
            $msg="success";
