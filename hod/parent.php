...
$dept = $_SESSION['dname'];
$results_per_page = 3;
$result = mysqli_query($link, "SELECT * FROM parent where erno IN(select erno from student where dept='$dept')");
...
$resu = mysqli_query($link, "Select * from parent where erno IN(select erno from student where dept='$dept') LIMIT " . $this_page_first_result . ',' .  $results_per_page);
...
if (isset($_POST['filter'])) {
    $year = $_POST['year'];
    if ($year == 'Year') {
        $resu = mysqli_query($link, "Select * from parent where erno IN(select erno from student where dept='$dept' AND year='$year')");
    } else {
        $resu = mysqli_query($link, "Select * from parent where erno IN(select erno from student where dept='$dept')");
    }
    $num = mysqli_num_rows($resu);
    $n = 0;
}
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <form action="#" method="post">
                                            ...
                                            <div class="rs-select2--light rs-select2--sm">
                                                <select class="js-select2" name="erno">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="tr-shadow">
                                                    ...
                                                    <td><a href="photoupdate.php?phid=<?php echo $row['pid'] ?>&for=mother"><img class="image" src="../parent_photos/<?php echo $row['mphoto']; ?>" width="80px"></a></td>
                                                    ...
                                                    <td>
                                                        <div class="table-data-feature">
                                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                <a href="parent_edit.php?pid=<?php echo $row['pid']; ?>"><i class="zmdi zmdi-edit"></i></a>
                                                            </button>
                                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                                                <a href="parent_delete.php?pid=<?php echo $row['pid']; ?>"><i class="zmdi zmdi-delete"></i></a>
                                                            </button>
                                                            <button class="item" data-toggle="tooltip" data-placement="top" title="View" data-original-title="More" aria-describedby="tooltip181541">
                                                                <a href="parent_display.php?pid=<?php echo $row['pid'] ?>"><i class="zmdi zmdi-more"></i></a>
                                                            </button>
                                                        </div>
                                                    </td>
                                                </tr>
