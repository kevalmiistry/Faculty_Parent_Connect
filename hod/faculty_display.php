                                    ...
                                    <div class="card-body">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                               <label for="cc-payment" class="control-label mb-1">Post Name</label> 
                                                <div class="col-12 col-md-12">
                                                  <select name="pname" id="pname" class="form-control" readonly>
                                            ...
                                            <div class="form-group has-success">
                                            	...
                                            	<div class="col-12 col-md-12">
                                                    <select name="dname" id="select" class="form-control" readonly>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="cast" class="form-control" readonly>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="ma_status" class="form-control" readonly>
