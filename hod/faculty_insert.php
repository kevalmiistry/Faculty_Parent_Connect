...
or die ("could not copy file");
    ...
    strtoupper($fname);
    strtoupper($lname);
	$check_duplicate="select * from faculty where fname='$fname' AND lname='$lname'";
	...
	else
	{
		...
		//if(!isset($_GET['fid']))
		//{		
			$result = mysqli_query($link,"Insert into faculty(pname,dname,email,password,fname,lname,status,dob,cast,ma_status,country,mobile,pno,aadhar,address,photo) values('$pname','$dname','$email','$password',UPPER('$fname'),UPPER('$lname'),'$status','$dob','$cast','$ma_status','$country','$mobile','$pno','$aadhar','$address','$photo')");
            $msg="success";
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                            	<div class="card-header">
                                    <strong><center><font style="font-size:30px;">Faculty Form</font></center></strong>
                                </div>
                            </div>
