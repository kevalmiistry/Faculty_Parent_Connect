...
or die ("could not copy file");
	 ...
	 $result = mysqli_query($link,"insert into parent(erno,fathername,mothername,fmobile,mmobile,femail,memail,password,fphoto,mphoto,status) values('$erno',UPPER('$fathername'),UPPER('$mothername'),'$fmobile','$mmobile','$femail','$memail','$password','$fphoto','$mphoto','$status')");
            $msg="success";
