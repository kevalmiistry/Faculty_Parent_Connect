                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <?php
                                            $result = mysqli_query($link, "Select * from global where (publisher='admin' OR publisher='" . $session_faculty . "') AND (dname like '%$dname%' OR dname='ALL') AND date='$date' order by gid desc");
