...
if (isset($_POST['Submit'])) {
    ...
    if (isset($_POST['sall'])) {
        ...
        $result = mysqli_query($link, "Insert into global(publisher,title,desci,date,status,sem,dname) values('$session_faculty','$title','$desc','$date','$status','$sem','$dname')");
                                        ...
                                        <div class="card-body card-block">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="pub" value="<?php echo $session_faculty; ?>" class="form-control" required readonly>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="email-input" class=" form-control-label">For Semester</label>
                                                </div>
                                                <div class="col-12 col-md-9">
