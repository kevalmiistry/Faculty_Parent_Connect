                                        ...
                                        <div>
                                            <div class="row form-group">
                                                <div class="col-12 col-sm-3">
                                                    <input type="number" name="from_er" placeholder="From Enrollment No." class="form-control">
                                                </div>
                                            </div>

                                            <div class="row form-group">
                                                <div class="col-12 col-sm-3">
                                                    <input type="number" name="to_er" placeholder="To Enrollment No." class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
