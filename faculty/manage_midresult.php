                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="table-data__tool">
                                ...
                                <!---->
                                <form action="midresult_generate.php" method="post">

                                    <div class="rs-select2--light rs-select2--sm">
                                        <select class="js-select2" name="gsem">
                                            <option value="sem">Sem</option>
                                            <?php
                                            $ressem = mysqli_query($link, "select * from sem where sem=$asem");
                                    ...
                                    <div class="rs-select2--light rs-select2--sm">
                                        <select class="js-select2" name="gyear">
                                            <option value="year">Year</option>
                                            <?php
                                            $resyear = mysqli_query($link, "select * from year where year=$ayear");
                            ...
                            $resmidrec = mysqli_query($link, "select * from midresult where sem='$asem' AND year='$ayear' AND dname='$dname' GROUP BY sem,year,subcode,faculty_no ORDER BY mid DESC");
                                ...
                                <div class="table-responsive table-responsive-data2"><br>
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $resmm = mysqli_query($link, "select * from midresult where sem='$asem' AND year='$ayear' AND dname='$dname' AND subcode='" . $rowmidrec['subcode'] . "'");
