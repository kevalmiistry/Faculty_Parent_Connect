                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div>
                                <i style="margin-left:20px;" class="fa fa-chevron-left"><a style="margin-left:10px;" href="global.php">Back</a></i>
                            </div>
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <?php
                                            $result = mysqli_query($link, "Select * from global where (publisher='admin' OR publisher='$hodname') AND (dname like '%$dname%' OR dname='ALL') AND status='ACTIVE' AND date='$g_date' order by gid desc");
